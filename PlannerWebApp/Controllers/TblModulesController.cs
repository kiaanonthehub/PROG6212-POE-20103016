...
namespace PlannerWebApp.Controllers
{
    public class TblModulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ModuleId,ModuleName,ModuleCredits,ModuleClassHours")] Module module)
        {
            if (ModelState.IsValid)
            {

                TblModule tblModule = new TblModule();
                tblModule.ModuleId = module.ModuleId;
                tblModule.ModuleName = module.ModuleName;
                tblModule.ModuleCredits = module.ModuleCredits;
                tblModule.ModuleClassHours = module.ModuleClassHours;
                ...
                tblStudentModule.ModuleId = module.ModuleId;
                tblStudentModule.ModuleSelfStudyHour = (decimal?)module.SelfStudyHours();
                _context.Add(tblStudentModule);
